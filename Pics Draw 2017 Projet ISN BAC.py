...
"""VARIALBE"""
#INITIALISATION VARIABLE-DESSIN
b1 = "up"
xold, yold = None,None
police="arial"
u="black"
...
#Fonction position pour l'activation du choix : RETOUCHE PHOTO/DESSIN
def deplace(evt) :
...
def Fonction(evt) :
    ...
    if choix == 1 :
        ...
        #OUVERTURE IMAGES POUR HDR + CREATION CANEVAS RESPECTIFS
        def deux():
            global img, img1, img2,fichier,fichier1,fichier2
        ...
        def photomaton():
            ...
            while y<=a:
                if y % 2 ==0:
                    ...
                    y3=((R,V,B))
                    xyimp.append(y3)
                    xpaireyimp.append(y3)
                    y=y+1

            imNew= Image.new(img.mode,img.size)
            imNew.putdata(xypaire)
            imNew.putdata(xpaireyimp)
            imNew.putdata(ximpypaire)
            imNew.putdata(xyimp)
            Can22.image=ImageTk.PhotoImage(imNew)
            Can22.create_image(0,0,image=Can22.image,anchor='nw')


        # POUR UTILISER LE PHOTOMATON PLUSIEURS FOIS
        def photomaton2():
            global imNew
        ...
        #FONCTION POUR OUVRIR ET ACTIVER LES BOUTTONS "RACCOURCIS"
        def clic(evt):
            ...
            if evt.widget==button :
                ...
                buttonh= Button(fenetre, text="        HDR        ",command=HDR)
        ...
        menu3.add_separator()
        menu3.add_command(label="HDR", command=HDR)
    ...
    if choix == 2 :
            ...
            #VAIRABLE GLOBAL
            global Candessin1,x,cann1,Cann2,Cann3,Cann33,Cann333,Cann44,Cann55,Cann66,Cannn77
            global Cann88,Cannn1,Cannn2,Cannn3,Cann33,Cannn33,Cannn333,Cannn44,Cannn55,Cannn66,Cannn88
            ...
            ##Affichage image pour canvas
            Candessin1.img=PhotoImage()

            ##image choix épaisseur crayon
            ...
            #CANEVAS
            ##creation canvas pour les images : choix epaisseur crayon
            ...
            #TEXTE
            ##Affichage paramètre pour le texte
            ...
            #TEXTE-Choix police
            ##Arial
            txt=Label(fenetre2, text="Arial",font="Arial",bg="gainsboro")
            txt.place(x=1030,y=295)
            ##ITALIC
            txt=Label(fenetre2, text="Italic", font="President 18 italic",bg="gainsboro")
            txt.place(x=1015,y=350)
            ##GRAS
            txt=Label(fenetre2, text="Gras",font="Verdana 14 bold",bg="gainsboro")
            txt.place(x=1020,y=410)


            #ARIANE POLICE INITIAL
            ## AFFICHAGE POLICE INIIAL ARIAL
            ...
            #EFFACER CANVEVAS DESSIN
            def eff():
                Candessin1.delete(ALL)


            # CHOIX POLICE + AFFICHAGE DU CHOIX
            ##ARIANE
            def ariane():
                global police
                police="Arial"
            ...
            #CHOIX COULEUR + Affichage Couleur choisit : augmentation du contour
            ...
            def clic1(evt) :
             ...
             #ARRIERE PLAN- FOND UNI DE LA COULEUR CHOISIT
             if evt.widget==Cany:
                Candessin1.create_line(0,2000,0,0,fill=u,width=10000)


             #AFFICHAGE CRAYON CHOISIT - EPAISSEUR DU CONTOUR
             ##GOMME
            ...
            #FONCTIONS PRINCIPALES DESSIN
            ##SI CLIC GAUCHE ENFONCE
            def b1down(evt):
                    global b1
                    b1 = "down"
                    xold=1
            ...
            ##COULEURS SUPPLEMENTAIRE CRAYON
            def coul():
            ...
            #CHANGER COULEUR ET EPAISSEUR DU CHOIX
            if'<ButtonPress-1>':
                fenetre2.bind('<ButtonPress-1>',clic1)

            #FONCTION PRINCIPAL DESSIN
...
Fond.bind('<ButtonPress-1>',Fonction)
Fenetre.mainloop()
