...
def RetouchePhoto(evt) :
    ...
    if choix == 1 :
        ...
        ##TOUTES LES IMAGES
        def tteff():
            Can12 = Canvas(fenetre,width=450,height=450,bg="red")
            Can12.place(x=25,y=55)
            Can22 = Canvas(fenetre,width=450,height=450,bg="red")
            Can22.place(x=497,y=55)
...
#CHOIX DESSIN
    ...
    if choix == 2 :
            ...
            #Affichage Couleur choisit : augmentation du contour
            ...
            def clic1(evt) :
             ...
             #ARRIERE PLAN DE LA COULEUR CHOISIT
             if evt.widget==Cany:
                Candessin1.create_line(0,2000,0,0,fill=u,width=10000)


             #AFFICHAGE EPAISSEUR CRAYON CHOISIT OU CHOIX DE LA GOMME
             ##GOMME
            ...
            #CHANGER COULEUR ET EPAISSEUR CRAYON
            if'<ButtonPress-1>':
...
#Fond.bind('<ButtonPress-1>',RetouchePhoto)
Fenetre.mainloop()
